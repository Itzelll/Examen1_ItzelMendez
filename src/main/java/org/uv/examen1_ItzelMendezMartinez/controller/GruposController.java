...
import org.uv.examen1_ItzelMendezMartinez.modelos.Grupos;
...
public class GruposController {
    ...
    @GetMapping
    public ResponseEntity<Page<Grupos>> listGrupos(Pageable pageable) {
        return ResponseEntity.ok(gruposRepository.findAll(pageable));
    }
